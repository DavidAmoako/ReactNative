      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold">TheHandyMan</span>
          </div>
        ...
        <CardContent>
          <Tabs value={userType} onValueChange={setUserType} className="mb-6">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="user">Homeowner</TabsTrigger>
              <TabsTrigger value="worker">Professional</TabsTrigger>
            </TabsList>
          </Tabs>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            {userType === "worker" && (
              <div className="space-y-2">
                ...
                <Textarea id="bio" placeholder="Tell us about your skills and experience..." className="min-h-[80px]" />
              </div>
            )}
