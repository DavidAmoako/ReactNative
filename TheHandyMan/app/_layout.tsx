  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          Browse through a list of skilled professionals ready to assist you with household services.
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle">Step 2: Book an Appointment</ThemedText>
        <ThemedText>
          Schedule a convenient time for the service you need.
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
