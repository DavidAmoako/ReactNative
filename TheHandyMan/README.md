#A1CEDC', dark: '#1D3D47' }}
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          Select a service and book an appointment with a professional.
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle">Step 3: Rate Your Experience</ThemedText>
        <ThemedText>
          After the service, rate your experience and provide feedback.
        </ThemedText>
      </ThemedView>
    </ParallaxScrollView>
  );
